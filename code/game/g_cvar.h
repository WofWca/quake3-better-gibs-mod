...
G_CVAR( g_gibsOnStompMinSpeed, "g_gibsOnStompMinSpeed", "600", CVAR_ARCHIVE, 0, qfalse, qfalse )
G_CVAR( g_gibsOnStompAffectLivePlayers, "g_gibsOnStompAffectLivePlayers", "0.0", 0, 0, qtrue, qfalse )
