...
// latched vars
G_CVAR( g_gametype, "g_gametype", "0", CVAR_SERVERINFO | CVAR_USERINFO | CVAR_LATCH, qfalse )
...
G_CVAR( g_fraglimit, "fraglimit", "20", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, qtrue )
G_CVAR( g_timelimit, "timelimit", "0", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, qtrue )
G_CVAR( g_capturelimit, "capturelimit", "8", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, qtrue )

G_CVAR( g_synchronousClients, "g_synchronousClients", "0", CVAR_SYSTEMINFO, qfalse )

G_CVAR( g_friendlyFire, "g_friendlyFire", "0", CVAR_ARCHIVE, qtrue )

G_CVAR( g_teamAutoJoin, "g_teamAutoJoin", "0", CVAR_ARCHIVE, qfalse )
G_CVAR( g_teamForceBalance, "g_teamForceBalance", "0", CVAR_ARCHIVE, qfalse )

G_CVAR( g_warmup, "g_warmup", "20", CVAR_ARCHIVE, qtrue )
G_CVAR( g_doWarmup, "g_doWarmup", "0", CVAR_ARCHIVE, qtrue )
G_CVAR( g_logfile, "g_log", "games.log", CVAR_ARCHIVE, qfalse )
G_CVAR( g_logfileSync, "g_logsync", "0", CVAR_ARCHIVE, qfalse )
...
G_CVAR( g_gravity, "g_gravity", "800", 0, qtrue )
G_CVAR( g_knockback, "g_knockback", "1000", 0, qtrue )
G_CVAR( g_quadfactor, "g_quadfactor", "3", 0, qtrue )
G_CVAR( g_weaponRespawn, "g_weaponrespawn", "5", 0, qtrue )
G_CVAR( g_weaponTeamRespawn, "g_weaponTeamRespawn", "30", 0, qtrue )
...
G_CVAR( g_podiumDist, "g_podiumDist", "80", 0, qfalse )
G_CVAR( g_podiumDrop, "g_podiumDrop", "70", 0, qfalse )

G_CVAR( g_allowVote, "g_allowVote", "1", CVAR_ARCHIVE, qfalse )
G_CVAR( g_listEntity, "g_listEntity", "0", 0, qfalse )

#ifdef MISSIONPACK
G_CVAR( g_obeliskHealth, "g_obeliskHealth", "2500", 0, qfalse )
G_CVAR( g_obeliskRegenPeriod, "g_obeliskRegenPeriod", "1", 0, qfalse )
G_CVAR( g_obeliskRegenAmount, "g_obeliskRegenAmount", "15", 0, qfalse )
G_CVAR( g_obeliskRespawnDelay, "g_obeliskRespawnDelay", "10", CVAR_SERVERINFO, qfalse )

G_CVAR( g_cubeTimeout, "g_cubeTimeout", "30", 0, qfalse )
G_CVAR_EXT( g_redteam, "g_redteam", "Stroggs", CVAR_ARCHIVE | CVAR_SERVERINFO | CVAR_USERINFO , 0, qtrue, qtrue )
G_CVAR_EXT( g_blueteam, "g_blueteam", "Pagans", CVAR_ARCHIVE | CVAR_SERVERINFO | CVAR_USERINFO , 0, qtrue, qtrue )
G_CVAR( g_singlePlayer, "ui_singlePlayerActive", "", 0, qfalse )

G_CVAR( g_enableDust, "g_enableDust", "0", CVAR_SERVERINFO, qtrue )
G_CVAR( g_enableBreath, "g_enableBreath", "0", CVAR_SERVERINFO, qtrue )
G_CVAR( g_proxMineTimeout, "g_proxMineTimeout", "20000", 0, qfalse )
#endif
G_CVAR( g_smoothClients, "g_smoothClients", "1", 0, qfalse )
G_CVAR( pmove_fixed, "pmove_fixed", "0", CVAR_SYSTEMINFO, qfalse )
G_CVAR( pmove_msec, "pmove_msec", "8", CVAR_SYSTEMINFO, qfalse )

G_CVAR( g_rankings, "g_rankings", "0", 0, qfalse )
G_CVAR( g_localTeamPref, "g_localTeamPref", "", 0, qfalse )
