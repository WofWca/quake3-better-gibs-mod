...
G_CVAR( g_cheats, "sv_cheats", "", 0, NO_TRACK, NULL )
...
G_CVAR( g_dedicated, "dedicated", "0", 0, NO_TRACK, NULL )

G_CVAR( g_speed, "g_speed", "320", 0, TRACK, NULL )
G_CVAR( g_gravity, "g_gravity", "800", 0, TRACK, NULL )
G_CVAR( g_knockback, "g_knockback", "1000", 0, TRACK, NULL )
G_CVAR( g_quadfactor, "g_quadfactor", "3", 0, TRACK, NULL )
G_CVAR( g_weaponRespawn, "g_weaponrespawn", "5", 0, TRACK, NULL )
G_CVAR( g_weaponTeamRespawn, "g_weaponTeamRespawn", "30", 0, TRACK, NULL )
G_CVAR( g_forcerespawn, "g_forcerespawn", "20", 0, TRACK, NULL )
G_CVAR( g_inactivity, "g_inactivity", "0", 0, TRACK, NULL )
G_CVAR( g_debugMove, "g_debugMove", "0", 0, NO_TRACK, NULL )
G_CVAR( g_debugDamage, "g_debugDamage", "0", 0, NO_TRACK, NULL )
G_CVAR( g_debugAlloc, "g_debugAlloc", "0", 0, NO_TRACK, NULL )
G_CVAR( g_motd, "g_motd", "", 0, NO_TRACK, NULL )
G_CVAR( g_blood, "com_blood", "1", 0, NO_TRACK, NULL )

G_CVAR( g_podiumDist, "g_podiumDist", "80", 0, NO_TRACK, NULL )
G_CVAR( g_podiumDrop, "g_podiumDrop", "70", 0, NO_TRACK, NULL )

G_CVAR( g_allowVote, "g_allowVote", "1", CVAR_ARCHIVE, NO_TRACK, NULL )
G_CVAR( g_listEntity, "g_listEntity", "0", 0, NO_TRACK, NULL )
...
#ifdef MISSIONPACK
G_CVAR( g_obeliskHealth, "g_obeliskHealth", "2500", 0, NO_TRACK, NULL )
G_CVAR( g_obeliskRegenPeriod, "g_obeliskRegenPeriod", "1", 0, NO_TRACK, NULL )
G_CVAR( g_obeliskRegenAmount, "g_obeliskRegenAmount", "15", 0, NO_TRACK, NULL )
G_CVAR( g_obeliskRespawnDelay, "g_obeliskRespawnDelay", "10", CVAR_SERVERINFO, NO_TRACK, NULL )

G_CVAR( g_cubeTimeout, "g_cubeTimeout", "30", 0, NO_TRACK, NULL )
...
G_CVAR( g_singlePlayer, "ui_singlePlayerActive", "", 0, NO_TRACK, NULL )
...
G_CVAR( g_proxMineTimeout, "g_proxMineTimeout", "20000", 0, NO_TRACK, NULL )
#endif
G_CVAR( g_smoothClients, "g_smoothClients", "1", 0, NO_TRACK, NULL )
